...
<script>
  ...
  import JDate from 'wanxi-vue-component/src/components/jeecg/JDate.vue';
  import JSelectUserByDep from 'wanxi-vue-component/src/components/jeecgbiz/JSelectUserByDep'
