        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="客户生日" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="birthday">
              <j-date placeholder="请选择客户生日" v-model="model.birthday" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
 ...
 import { VALIDATE_FAILED } from 'wanxi-vue-component/src/components/jeecg/JVxeTable/utils/vxeUtils.js'
  export default {
