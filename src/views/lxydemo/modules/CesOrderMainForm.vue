...
<script>
  ...
  import { JVxeTableModelMixin } from 'wanxi-vue-component/src/mixins/JVxeTableModelMixin.js'
  import { JVXETypes } from 'wanxi-vue-component/src/components/jeecg/JVxeTable'
  import { getRefPromise,VALIDATE_FAILED} from 'wanxi-vue-component/src/components/jeecg/JVxeTable/utils/vxeUtils.js'
  import { validateDuplicateValue } from 'wanxi-vue-fm/src/utils/util'
  import JFormContainer from 'wanxi-vue-component/src/components/jeecg/JFormContainer'
