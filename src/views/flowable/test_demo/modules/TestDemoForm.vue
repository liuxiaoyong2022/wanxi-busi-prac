    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="流程选择" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="selTable">
              <j-search-select-tag v-model="model.processDefinitionKey" dict="act_re_procdef,name_,key_"  />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
